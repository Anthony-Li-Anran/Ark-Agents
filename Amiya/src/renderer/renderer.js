...
function showSystemNotification() {
    // Hide any existing bubbles when showing notification
    hideAIBubble();
    ...
    // Auto-hide after 3 seconds, wait for animation to finish, then show greeting bubble
    setTimeout(() => {
        hideSystemNotification();
        // Wait for notification fade-out animation (400ms) before showing greeting
